...
import { User, Briefcase, Mail, Lock, Sparkles, Loader2, ArrowRight } from 'lucide-react';
      ...
      <div className="max-w-[480px] w-full">
        <div className="bg-white rounded-[2.5rem] shadow-2xl shadow-slate-200/60 p-8 sm:p-10 border border-slate-100">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            {/* Password Input */}
            <div className="space-y-1.5">
              <label className="text-[11px] font-black text-slate-400 uppercase tracking-widest ml-1">Security</label>
              <div className="relative group">
